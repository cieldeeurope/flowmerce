...
import { JimmychooModule } from './jimmychoo/jimmychoo.module';
import { VersaceModule } from './versace/versace.module';
import { BerlutiModule } from './berluti/berluti.module';
import { EtroModule } from './etro/etro.module';
import { OffwhiteModule } from './offwhite/offwhite.module';
import { PlatformModule } from './platform/platform.module';
import { PlatformMapping } from './platform/platform-mapping.entity';
import { PlatformProduct } from './platform/platform-product.entity';
import { PlatformCategory } from './category/PlatformCategory.entity';
import { TwentyFourSModule } from './24s/24s.module';
import { MytheresaModule } from './mytheresa/mytheresa.module';
import { BrownsModule } from './browns/browns.module';
import { GiglioModule } from './giglio/giglio.module';
import { TheDoubleFModule } from './thedoublef/thedoublef.module';
import { Club21Module } from './club21/club21.module';
import { TwentyFourSDesigner } from './category/TwentyFourSDesigner.entity';
import { MytheresaDesigner } from './category/MytheresaDesigner.entity';
import { BrownsDesigner } from './category/BrownsDesigner.entity';
import { PaymentModule } from './payment/payment.module';


@Module({
  imports: [
    TypeOrmModule.forFeature([SelectedDesigners,Mapping,Product,GodoMallCategory,Category,Margin,WordReplacement,FarfetchDesigner,TwentyFourSDesigner,MytheresaDesigner,BrownsDesigner,CettireDesigner,SmartStoreCategory,HostingAccount,User,Schedule,Contact,Cafe24Category,MakeshopCategory,PlatformProduct,PlatformMapping,PlatformCategory
    ]),
