...
export class MappingController {
  ...
  @Post('/alaia')
  saveAlaia(@Body() body: any) {
    return this.saveBySite('Alaia', body);
  }

  @Post('/cpcompany')
  saveCpcompany(@Body() body: any) {
    return this.saveBySite('CPcompany', body);
  }

  @Post('/delvaux')
  saveDelvaux(@Body() body: any) {
    return this.saveBySite('Delvaux', body);
  }

  @Post('/rogervivier')
  saveRogervivier(@Body() body: any) {
    return this.saveBySite('Rogervivier', body);
  }

  @Post('/toteme')
  saveToteme(@Body() body: any) {
    return this.saveBySite('Toteme', body);
  }

  @Post('/jimmychoo')
  saveJimmychoo(@Body() body: any) {
    return this.saveBySite('Jimmychoo', body);
  }

  @Post('/versace')
  saveVersace(@Body() body: any) {
    return this.saveBySite('Versace', body);
  }

  @Post('/berluti')
  saveBerluti(@Body() body: any) {
    return this.saveBySite('Berluti', body);
  }

  @Post('/offwhite')
  saveOffwhite(@Body() body: any) {
    return this.saveBySite('Offwhite', body);
  }

  @Post('/etro')
  saveEtro(@Body() body: any) {
    return this.saveBySite('Etro', body);
  }
