...
@Module({
  imports: [
    TypeOrmModule.forFeature([SelectedDesigners,Mapping,Product,GodoMallCategory,Category,Margin,WordReplacement,FarfetchDesigner,CettireDesigner,SmartStoreCategory,HostingAccount,User,Schedule,Contact,Cafe24Category,MakeshopCategory,PlatformProduct,PlatformMapping,PlatformCategory
    ]),
