...
import { PlatformCategory } from './PlatformCategory.entity';

@Module({
  imports: [TypeOrmModule.forFeature([Category,GodoMallCategory,FarfetchDesigner,CettireDesigner,SmartStoreCategory,Cafe24Category,MakeshopCategory,PlatformCategory
  ])],
