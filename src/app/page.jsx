...
const homeTitle = "쇼핑몰 자동화 솔루션";
const homeDescription =
   "상품 등록 자동화부터 SEO 상품명 최적화, 재고 연동, 원격 수집 운영까지 한 번에 관리하는 쇼핑몰 자동화 솔루션, 플로우머스.";
...
export default function Home() {
   const structuredData = [
      ...
      },
      {
         ...
         description:
            "스마트스토어, 고도몰, 카페24, 메이크샵 등 쇼핑몰 운영에 필요한 상품 등록 자동화, 광고 연동, SEO 상품명 최적화, 재고 수집 운영을 지원하는 솔루션입니다.",
      },
   ];
