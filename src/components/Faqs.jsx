...
export default function Faqs() {
   const faqs = [
      ...
      {
         id: "06-1",
         question: "세팅할 때 어떤 정보를 보내야 하나요?",
         answer:
            "플랜 결제와 사이트 선택이 끝나면 연동할 쇼핑몰 관리자 URL, 로그인 아이디, 비밀번호를 전달해주셔야 합니다. partnerKey와 apiKey를 직접 찾기 어려운 경우가 많아 대부분은 카카오톡 상담으로 관리자 정보만 먼저 보내주시면 되고, 플로우머스가 필요한 키 확인 방법까지 함께 안내드립니다.",
      },
      {
         id: "07",
