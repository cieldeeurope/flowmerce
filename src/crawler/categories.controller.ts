...
export class CategoriesController {
  ...
  @Get('/cpcompany')
  getCpcompany() {
    return this.getBySite('CPcompany');
  }

  @Get('/rogervivier')
  getRogervivier() {
    return this.getBySite('Rogervivier');
  }

  @Get('/alaia')
  getAlaia() {
    return this.getBySite('Alaia');
  }

  @Get('/toteme')
  getToteme() {
    return this.getBySite('Toteme');
  }

  @Get('/delvaux')
  getDelvaux() {
    return this.getBySite('Delvaux');
  }
